...
io_data_descriptor_file = pytest.fixture(scope="module")(fixtures.io_data_descriptor_file)
io_data_descriptors = pytest.fixture(scope="module")(fixtures.io_data_descriptors)
...
io_data_resolver = pytest.fixture(scope="module")(fixtures.io_data_resolver)
io_data = pytest.fixture(scope="function")(fixtures.io_data)
